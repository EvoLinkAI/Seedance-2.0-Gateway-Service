...
<p align="center">
  在同一份指南中掌握 Seedance 2.0 API 價格、模型、text-to-video、image-to-video 與 reference-to-video。
</p>
...
Seedance 2.0 API 是一套 AI 影片生成 API，可透過文字提示、圖片與多模態參考素材建立影片。透過 EvoLink.ai，開發者可以用一致的 API 流程存取完整的 Seedance 2.0 模型家族：
...
使用一次 API 呼叫建立 Seedance 2.0 影片生成任務：
