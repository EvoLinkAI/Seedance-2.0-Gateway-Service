...
# Guide des prix, modèles et de la génération vidéo avec Seedance 2.0 API
...
<p align="center">
  Prix de Seedance 2.0 API, modèles, text-to-video, image-to-video et reference-to-video dans un guide unique.
</p>
...
<p align="left">
  ...
  <a href="https://docs.evolink.ai">Lire la documentation API</a>
</p>

## Qu’est-ce que Seedance 2.0 API ?

Seedance 2.0 API est une API de génération vidéo pour créer des vidéos IA à partir de prompts texte, d’images et de références multimodales. Via EvoLink.ai, les développeurs peuvent accéder à toute la famille de modèles Seedance 2.0 avec un workflow API cohérent :
...
- comprendre le prix de Seedance 2.0 API et les différences entre modèles
...
### Seedance 2.0 API est-elle synchrone ?
